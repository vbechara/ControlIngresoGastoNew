...
namespace ControlIngresoGastoNew.Controllers
{
    public class IngresoGastoController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? mes, int?anio)
        {
            ...
            ViewData["mes"] = mes;
            ViewData["anio"] = anio; 
            var applicationDbContext = _context.IngresoGasto.Include(i => i.Categoria).Where(c=> c.Fecha.Month == mes && c.Fecha.Year== anio) ;
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoriaId,Fecha,Valor")] IngresoGasto ingresoGasto)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categorias.Where(c=>c.Estado==true), "id", "NombreCategoria", ingresoGasto.CategoriaId);
            return View(ingresoGasto);
        }
